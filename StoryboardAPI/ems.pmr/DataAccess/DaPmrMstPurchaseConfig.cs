...
//{
//    public class DaPmrMstPurchaseConfig
//    {
//    }
//}
...
namespace ems.pmr.DataAccess
{
    public class DaPmrMstPurchaseConfig
    {
        ...
        int mnResult;
        string lsaddoncharges, lsadditionaldiscount, lsfreightcharges, lspacking_forwardingcharges, lsinsurancecharges, lscontractpo;

        public void DaGetAllChargesConfig(string employee_gid, MdlPmrMstPurchaseConfig values)
        {
            try
            {
        ...
        public void DaUpdateAddOnChargesConfig(string employee_gid, salesconfiglist values)
        {
            try
            {
                ...
                msSQL = " update pmr_mst_tpurchaseconfig set " +
                        " flag = '" + lsaddoncharges + "'," +
        ...
        public void DaUpdateContractPOConfig(string employee_gid, salesconfiglist values)
        {
            try
            {
                if (values.contractpo == true)
                {
                    lscontractpo = "Y";
                }
                else
