...
{
    public class MdlPmrRptPurchaseOrder : result
    {
        public List<GetPurchaseOrderForLastSixMonths_List> GetPurchaseOrderForLastSixMonths_List { get; set; }
    ...
    public class GetPurchaseOrderForLastSixMonths_List : result
    {
    ...
    public class GetOrderDetailSummary : result
    {
        ...
        public string contact_details { get; set; }
        public string purchaseorder_status { get; set; }
        public string purchaseperson_name { get; set; }
        public string grandtotal_l { get; set; }
        public string purchaseorder_gid { get; set; }
