...
{
    public class DaSmrRptSalesLedger
    {
        ...
        public void DaGetsalesLedgersummary(string user_gid, MdlSmrRptSalesLedger values)
        {
            try
            {
                msSQL = " SELECT a.invoice_refno, DATE_FORMAT(a.invoice_date, '%d-%m-%Y') AS invoice_date, a.customer_name, " +
                    " a.customer_address, a.invoice_gid, c.customer_code, a.customer_gid, a.customer_contactnumber, " +
                    " e.account_name, CONCAT(c.customer_id, '/', a.customer_name) AS customer, FORMAT(a.total_amount, 2) AS total_amount, " +
                    ...
                    " ELSE e.account_name END AS sales_type " +
        ...
        public void DaGetsalesLedgerdate(string from_date, string to_date, MdlSmrRptSalesLedger values)
        {
            try
            {
            ...
            {
                values.message = "Exception occured while loading  Sales Ledger !";
