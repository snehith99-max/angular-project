...
@Component({
  selector: 'app-acc-mst-chartofaccountliabilityview',
  templateUrl: './acc-mst-chartofaccountliabilityview.component.html',
  styleUrls: ['./acc-mst-chartofaccountliabilityview.component.scss']
})
export class AccMstChartofaccountliabilityviewComponent {
  account_gid:any;
  lsaccount_gid:any;
