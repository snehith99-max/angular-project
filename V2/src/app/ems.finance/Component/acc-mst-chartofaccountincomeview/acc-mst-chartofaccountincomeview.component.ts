...
@Component({
  selector: 'app-acc-mst-chartofaccountincomeview',
  templateUrl: './acc-mst-chartofaccountincomeview.component.html',
  styleUrls: ['./acc-mst-chartofaccountincomeview.component.scss']
})
export class AccMstChartofaccountincomeviewComponent {
  account_gid:any;
  lsaccount_gid:any;
