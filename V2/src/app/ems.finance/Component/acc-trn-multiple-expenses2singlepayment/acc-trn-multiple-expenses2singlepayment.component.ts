...
@Component({
  selector: 'app-acc-trn-multiple-expenses2singlepayment',
  templateUrl: './acc-trn-multiple-expenses2singlepayment.component.html',
  styleUrls: ['./acc-trn-multiple-expenses2singlepayment.component.scss']
})
export class AccTrnMultipleExpenses2singlepaymentComponent {
  ...
  ngOnInit(): void {
    ...
    this.Getmultipleexpense2employee(deencryptedParam)
  ...
  Getmultipleexpense2employee(params: any) {
    var param = {
        vendor_gid: params
    };
    ...
    var url = 'AccTrnPayment/GetpaymentexpenseSummary'
    this.NgxSpinnerService.show();
    this.service.getparams(url, param).subscribe((result: any) => {
      this.responsedata = result;
      this.singlepayment_list = this.responsedata.GetMultipleexpenseSummary;
  ...
  onsubmit() {
    ...
    this.NgxSpinnerService.show();
    var api = 'AccTrnPayment/Postmultipleexpense2singlepayment';
