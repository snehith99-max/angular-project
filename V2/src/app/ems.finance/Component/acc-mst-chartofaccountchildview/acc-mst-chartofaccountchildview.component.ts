...
@Component({
  selector: 'app-acc-mst-chartofaccountchildview',
  templateUrl: './acc-mst-chartofaccountchildview.component.html',
  styleUrls: ['./acc-mst-chartofaccountchildview.component.scss']
})
export class AccMstChartofaccountchildviewComponent {
  account_gid:any;
  lsaccount_gid:any;
