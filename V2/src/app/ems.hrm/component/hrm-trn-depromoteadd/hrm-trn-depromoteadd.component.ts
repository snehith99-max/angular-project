...
@Component({
  selector: 'app-hrm-trn-depromoteadd',
  templateUrl: './hrm-trn-depromoteadd.component.html',
  styleUrls: ['./hrm-trn-depromoteadd.component.scss']
})
export class HrmTrnDepromoteaddComponent {
  parameterValue: any;
  ...
  ngOnInit(): void {
    ...
    var api='HrmTrnDePromote/GetEmployeeNameDtl'
    this.service.get(api).subscribe((result:any)=>{
    this.employeelist = result.GetEmployeeuser_Dtl;
   });
   var api='HrmTrnDePromote/GetBranchNameDtl'
   this.service.get(api).subscribe((result:any)=>{
   this.branchlist = result.GetBranchuser_Dtl;
  });
  var api='HrmTrnDePromote/GetDepartmentNameDtl'
   this.service.get(api).subscribe((result:any)=>{
   this.departmentlist = result.GetDepartmentuser_Dtl;
  });
  var api='HrmTrnDePromote/GetDesignationNameDtl'
   this.service.get(api).subscribe((result:any)=>{
   this.designationlist = result.GetDesignationuser_Dtl;
  });
  ...
  var url = 'HrmTrnDePromote/GetEmployeeDetail'
 
  this.service.getparams(url, param).subscribe((result: any) => {
  this.responsedata=result;
    this.employeedetail_list = result.GetEmployeeUserData_Detail;
 ...
 onconfirm(): void {
  ...
  this.service.post(url, this.reactiveForm.value).subscribe((result: any) => {
    ...
    if (result.status == false) {
      ...
      this.router.navigate(['/hrm/HrmTrnDepromotedetailssummary']);
