...
@Component({
  selector: 'app-otl-trn-outletmanage-unassign',
  templateUrl: './otl-trn-outletmanage-unassign.component.html',
  styleUrls: ['./otl-trn-outletmanage-unassign.component.scss']
})
export class OtlTrnOutletmanageUnassignComponent {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    ngOnInit(): void {
      ...
      var vendorassign = 'OutletManage/GetotlAssignedManagerlist';
      this.service.getparams(vendorassign, param).subscribe((apiresponse: any) => {
        this.unassignmanager_list = apiresponse.GetOTLAssignedManagerlist;
    ...
    unassign(){
      debugger;
        ...
        this.CurObj.GetOTLAssignedManagerlist = this.pick
        this.CurObj.campaign_gid=this.campaign_gid
          if (this.CurObj.GetOTLAssignedManagerlist.length === 0) {
        ...
        debugger
        this.NgxSpinnerService.show();
          var url = 'OutletManage/PostoutAssignedManagerlist';  
