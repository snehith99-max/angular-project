...
@Component({
  selector: 'app-otl-trn-outletdirectpo',
  templateUrl: './otl-trn-outletdirectpo.component.html',
  styleUrls: ['./otl-trn-outletdirectpo.component.scss']
})
export class OtlTrnOutletdirectpoComponent {
  ...
  toggleExpand(section: string) {
    ...
    OnChangeBranch() {
      ...
      this.POAddForm.get("vendor_address")?.setValue(result.GetBranch[0].address1);
      });
