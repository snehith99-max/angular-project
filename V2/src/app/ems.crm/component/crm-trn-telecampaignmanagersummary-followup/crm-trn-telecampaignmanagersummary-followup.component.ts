...
@Component({
  selector: 'app-crm-trn-telecampaignmanagersummary-followup',
  templateUrl: './crm-trn-telecampaignmanagersummary-followup.component.html',
  styleUrls: ['./crm-trn-telecampaignmanagersummary-followup.component.scss'],
  styles: [`
  table thead th, 
  .table tbody td { 
   position: relative; 
...
export class CrmTrnTelecampaignmanagersummaryFollowupComponent {
  ...
  GetTelecallerManagerTotalSummary() {
    this.NgxSpinnerService.show();
    var url = 'TelecallerManager/GetTelecallerManagerFollowSummary'
