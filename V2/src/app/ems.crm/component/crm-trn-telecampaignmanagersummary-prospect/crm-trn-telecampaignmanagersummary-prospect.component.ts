...
@Component({
  selector: 'app-crm-trn-telecampaignmanagersummary-prospect',
  templateUrl: './crm-trn-telecampaignmanagersummary-prospect.component.html',
  styleUrls: ['./crm-trn-telecampaignmanagersummary-prospect.component.scss']
})
export class CrmTrnTelecampaignmanagersummaryProspectComponent {
 ...
 getleadbankgid(parameter: string) {
  ...
  GetTelecallerManagerTotalSummary() {
    this.NgxSpinnerService.show();
    var url = 'TelecallerManager/GetTelecallerManagerProspectSummary'
