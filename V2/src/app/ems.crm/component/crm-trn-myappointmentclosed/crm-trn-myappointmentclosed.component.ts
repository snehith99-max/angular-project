...
@Component({
  selector: 'app-crm-trn-myappointmentclosed',
  templateUrl: './crm-trn-myappointmentclosed.component.html',
  styleUrls: ['./crm-trn-myappointmentclosed.component.scss']
})
export class CrmTrnMyappointmentclosedComponent {
  responsedata: any;
  ...
  GetAppointmentSummary(){
    ...
    var url = 'MyAppointment/GetclosedappointmentSummary'
     this.service.get(url).subscribe((result: any) => {
  ...
  Onopen(param1: any,param2:any){
    ...
    const lspage1 = "My-Appointment-Closed";
