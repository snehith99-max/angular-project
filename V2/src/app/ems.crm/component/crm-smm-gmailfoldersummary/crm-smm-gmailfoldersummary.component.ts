...
@Component({
  selector: 'app-crm-smm-gmailfoldersummary',
  templateUrl: './crm-smm-gmailfoldersummary.component.html',
  styleUrls: ['./crm-smm-gmailfoldersummary.component.scss']
})
export class CrmSmmGmailfoldersummaryComponent {
  ...
  onsubmitfolder() {
    ...
    if (this.reactiveFormFolder.status === "VALID") {
      ...
      this.NgxSpinnerService.show();
      const url1 = 'GmailCampaign/CreateEmailLabel';
  ...
  GetMailSummary() {
    ...
    this.service.get(api).subscribe((result: any) => {
      ...
      if (this.folders != null && this.folders != undefined) {
        ...
        var api1 = 'GmailCampaign/GmailAPIinboxFolderSummary';
  ...
  async runBackgroundApiCall() {
    var api2 = 'GmailCampaign/GetEmailLabelDetails';
    try {
  ...
  selectEmail(email: Email) {
    ...
    this.first = this.sanitizer.bypassSecurityTrustHtml(decodedString);
    // Ensure the substring operation respects HTML tag boundaries
...
if(this.replytoid !=null && this.replytoid !="" && this.replytoid !='')
  ...
  onmovefolder() {
    ...
    if (this.movetofolder_list != null && this.movetofolder_list != undefined && this.movetofolder_list.length != 0) {
      ...
      if (this.reactiveFormFoldermove.status == 'VALID') {
        this.NgxSpinnerService.show();
        var url1 = 'GmailCampaign/MoveoneFoldertoother'
  ...
  onupdate() {
    ...
    if (this.reactiveFormFolderEdit.status === "VALID") {
      ...
      this.NgxSpinnerService.show();
      const url1 = 'GmailCampaign/UpdateEmailLabel';
  ...
  ondelete() {
    debugger
    this.NgxSpinnerService.show();
    var url = 'GmailCampaign/DeleteGmailLabel'
    let param = {
