...
@Component({
  selector: 'app-crm-trn-myappointmentpotential',
  templateUrl: './crm-trn-myappointmentpotential.component.html',
  styleUrls: ['./crm-trn-myappointmentpotential.component.scss']
})
export class CrmTrnMyappointmentpotentialComponent {
  responsedata: any;
  ...
  GetAppointmentSummary(){
    ...
    var url = 'MyAppointment/GetpotentialsappointmentSummary'
     this.service.get(url).subscribe((result: any) => {
       ...
       this.potential_value_count = this.gettotalappointmentsummary_lists[0].potential_value_count;
       setTimeout(() => {
  ...
  Onopen(param1: any,param2:any){
    ...
    const lspage1 = "My-Appointment-Potential";
