...
@Component({
  selector: 'app-crm-trn-telecampaignmanagersummary-pendingcalls',
  templateUrl: './crm-trn-telecampaignmanagersummary-pendingcalls.component.html',
  styleUrls: ['./crm-trn-telecampaignmanagersummary-pendingcalls.component.scss']
})
export class CrmTrnTelecampaignmanagersummaryPendingcallsComponent {
 ...
 getleadbankgid(parameter: string) {
  ...
  GetTelecallerManagerTotalSummary() {
    this.NgxSpinnerService.show();
    var url = 'TelecallerManager/GetTelecallerManagerPendingCallsSummary'
