...
@Component({
  selector: 'app-crm-trn-myvisitexpired',
  templateUrl: './crm-trn-myvisitexpired.component.html',
  styleUrls: ['./crm-trn-myvisitexpired.component.scss']
})
export class CrmTrnMyvisitexpiredComponent {
