...
@Component({
  selector: 'app-crm-trn-telemycampaign-followup',
  templateUrl: './crm-trn-telemycampaign-followup.component.html',
  styleUrls: ['./crm-trn-telemycampaign-followup.component.scss'],
  styles: [`
  table thead th, 
  .table tbody td { 
   position: relative; 
...
export class CrmTrnTelemycampaignFollowupComponent {
  ...
  ngOnInit(): void {
    ...
    // });
    var api8 = 'Mycalls/GetMycallsresponsefollowupdropdown';
  ...
  Getcallfollowupsummary() {
    var url = 'Mycalls/Getcallfollowupsummary'
  ...
  onadd() {
    const secretKey = 'storyboarderp';
    const lspage1 = 'Mycalls-followup';
    const lspage = AES.encrypt(lspage1, secretKey).toString();
