...
@Component({
  selector: 'app-crm-trn-telecampaignmanagersummary-longestleads',
  templateUrl: './crm-trn-telecampaignmanagersummary-longestleads.component.html',
  styleUrls: ['./crm-trn-telecampaignmanagersummary-longestleads.component.scss']
})
export class CrmTrnTelecampaignmanagersummaryLongestleadsComponent {
  responsedata: any;
  totallist: any;
  internal_notes: any;
  leadbank_name: any;
  ...
  GetTelecallerManagerTotalSummary() {
    ...
    var url = 'TelecallerManager/GetTelecallerManagerLongestLeadSummary'
  ...
  Onopen(param1: any, param2: any, param3: any,param4:any) {
    ...
    const lspage1 = "MM-teleLongestLead";
