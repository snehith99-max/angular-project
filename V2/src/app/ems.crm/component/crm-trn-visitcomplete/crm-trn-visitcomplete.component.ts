...
@Component({
  selector: 'app-crm-trn-visitcomplete',
  templateUrl: './crm-trn-visitcomplete.component.html',
  styleUrls: ['./crm-trn-visitcomplete.component.scss']
})
export class CrmTrnVisitcompleteComponent {
  ...
  GetExpiredSummary() {
    var url = 'Myvisit/GetCompletedSummary'
