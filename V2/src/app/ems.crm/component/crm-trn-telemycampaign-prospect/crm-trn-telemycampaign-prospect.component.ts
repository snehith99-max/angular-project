...
@Component({
  selector: 'app-crm-trn-telemycampaign-prospect',
  templateUrl: './crm-trn-telemycampaign-prospect.component.html',
  styleUrls: ['./crm-trn-telemycampaign-prospect.component.scss']
})
export class CrmTrnTelemycampaignProspectComponent {
  ...
  Getcallprospectsummary() {
    var url = 'Mycalls/Getcallprospectsummary'
  ...
  onadd() {
    const secretKey = 'storyboarderp';
    const lspage1 = 'Mycalls-prospect';
    const lspage = AES.encrypt(lspage1, secretKey).toString();
