...
@Component({
  selector: 'app-crm-trn-myappointmentsummary',
  templateUrl: './crm-trn-myappointmentsummary.component.html',
  styleUrls: ['./crm-trn-myappointmentsummary.component.scss']
})
export class CrmTrnMyappointmentsummaryComponent {
  responsedata: any;
  ...
  ngOnInit(){
    ...
    this.GetTotalAppointmentSummary();
  ...
  GetTotalAppointmentSummary(){
    this.NgxSpinnerService.show();
    var url = 'MyAppointment/GetTotalappointmentSummary'
     this.service.get(url).subscribe((result: any) => {
  ...
  Onopen(param1: any,param2: any){
    ...
    const lspage1 = "My-Appointment-Total";
