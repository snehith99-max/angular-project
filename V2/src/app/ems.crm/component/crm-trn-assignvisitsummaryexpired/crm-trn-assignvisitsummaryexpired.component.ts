...
@Component({
  selector: 'app-crm-trn-assignvisitsummaryexpired',
  templateUrl: './crm-trn-assignvisitsummaryexpired.component.html',
  styleUrls: ['./crm-trn-assignvisitsummaryexpired.component.scss']
})
export class CrmTrnAssignvisitsummaryexpiredComponent {
  ...
  Getassignvisitsummary() {
    var url = 'Assignvisit/GetassignvisitSummaryExpired'
