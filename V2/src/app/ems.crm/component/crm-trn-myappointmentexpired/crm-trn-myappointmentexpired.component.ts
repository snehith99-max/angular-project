...
@Component({
  selector: 'app-crm-trn-myappointmentexpired',
  templateUrl: './crm-trn-myappointmentexpired.component.html',
  styleUrls: ['./crm-trn-myappointmentexpired.component.scss']
})
export class CrmTrnMyappointmentexpiredComponent {
  responsedata: any;
  ...
  ngOnInit(){
    ...
    this.GetExpiredAppointmentSummary();
  ...
  GetExpiredAppointmentSummary(){
    this.NgxSpinnerService.show();
    var url = 'MyAppointment/GetExpiredappointmentSummary'
     this.service.get(url).subscribe((result: any) => {
  ...
  Onopen(param1: any,param2: any){
    ...
    const lspage1 = "My-Appointment-Expired";
    ...
    console.log('oiewmcoiwec',leadbank_gid)
  }
     //*******close textfields******//
