...
export class ManagerListComponent implements DoCheck, OnChanges {
	...
	constructor(private differs: IterableDiffers, private ToastrService: ToastrService, public service: SocketService, public getData: CrmMstCampaignsummaryComponent, private NgxSpinnerService: NgxSpinnerService) {
	...
	addbtn(source: TeamList, target: TeamList, item: any = null, trueup = true, campaign_gid: string) {
		...
		const url = 'CampaignSummary/PostManagerUnassignedlist';
