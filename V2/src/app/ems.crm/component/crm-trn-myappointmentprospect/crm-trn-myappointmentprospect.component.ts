...
@Component({
  selector: 'app-crm-trn-myappointmentprospect',
  templateUrl: './crm-trn-myappointmentprospect.component.html',
  styleUrls: ['./crm-trn-myappointmentprospect.component.scss']
})
export class CrmTrnMyappointmentprospectComponent {
  responsedata: any;
  ...
  GetAppointmentSummary(){
    ...
    var url = 'MyAppointment/GetprospectappointmentSummary'
     this.service.get(url).subscribe((result: any) => {
  ...
  Onopen(param1: any,param2: any){
    ...
    const lspage1 = "My-Appointment-Prospect";
