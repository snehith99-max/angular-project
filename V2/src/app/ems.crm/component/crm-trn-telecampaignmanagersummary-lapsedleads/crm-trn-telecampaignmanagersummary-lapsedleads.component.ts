...
@Component({
  selector: 'app-crm-trn-telecampaignmanagersummary-lapsedleads',
  templateUrl: './crm-trn-telecampaignmanagersummary-lapsedleads.component.html',
  styleUrls: ['./crm-trn-telecampaignmanagersummary-lapsedleads.component.scss']
})


export class CrmTrnTelecampaignmanagersummaryLapsedleadsComponent {
  responsedata: any;
  totallist: any;
  internal_notes: any;
  leadbank_name: any;
  ...
  GetTelecallerManagerTotalSummary() {
    ...
    var url = 'TelecallerManager/GetTelecallerManagerLaspsedLeadSummary'
  ...
  Onopen(param1: any, param2: any, param3: any,param4:any) {
    ...
    const lspage1 = "MM-teleLapsedLead";
