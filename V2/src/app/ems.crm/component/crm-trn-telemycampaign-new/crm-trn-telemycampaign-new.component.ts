...
@Component({
  selector: 'app-crm-trn-telemycampaign-new',
  templateUrl: './crm-trn-telemycampaign-new.component.html',
  styleUrls: ['./crm-trn-telemycampaign-new.component.scss']
})
export class CrmTrnTelemycampaignNewComponent {
  ...
  ngOnInit(): void {
    ...
    this.reactiveForm = new FormGroup({
      ...
      call_feedback: new FormControl(this.mycalls.call_feedback,[
        Validators.required,
 ...
 viewcalllog(parameter: string, parameter1: string, parameter2: string) {
  ...
  Getcallnewsummary() {
    var url = 'Mycalls/Getcallnewsummary'
  ...
  openModallog3(parameter: string) {
    ...
    // this.Getcallnewsummary(this.parameterValue1.leadbank_gid);
