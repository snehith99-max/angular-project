...
@Component({
  selector: 'app-crm-trn-assignvisitsummaryupcoming',
  templateUrl: './crm-trn-assignvisitsummaryupcoming.component.html',
  styleUrls: ['./crm-trn-assignvisitsummaryupcoming.component.scss']
})
export class CrmTrnAssignvisitsummaryupcomingComponent {
  ...
  Getassignvisitsummary() {
    var url = 'Assignvisit/GetassignvisitSummaryUpcoming'
