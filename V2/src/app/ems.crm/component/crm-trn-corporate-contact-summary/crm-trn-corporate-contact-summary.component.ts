...
@Component({
  selector: 'app-crm-trn-corporate-contact-summary',
  templateUrl: './crm-trn-corporate-contact-summary.component.html',
  styleUrls: ['./crm-trn-corporate-contact-summary.component.scss']
})
export class CrmTrnCorporateContactSummaryComponent {
  parametervalue: any;
  service: any;
  contact_gid: any;
  contact_list: any;
  ...
  ngOnInit(): void {
    ...
    var url= 'ContactManagement/ContactCorporateSummary';
    this.SocketService.get(url).subscribe((result:any)=>{
      if(result.contact_list != null){
        $('#contactsummary').DataTable().destroy();
        this.contact_list = result.contactCorporatesummary;  
