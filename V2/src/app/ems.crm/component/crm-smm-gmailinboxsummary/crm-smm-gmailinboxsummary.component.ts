...
@Component({
  selector: 'app-crm-smm-gmailinboxsummary',
  templateUrl: './crm-smm-gmailinboxsummary.component.html',
  styleUrls: ['./crm-smm-gmailinboxsummary.component.scss']
})
export class CrmSmmGmailinboxsummaryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.routerEventsSubscription = this.router.events.subscribe((event: any) => {
      if (event instanceof NavigationEnd) {
        ...
        if (currentPath === '/crm/CrmSmmGmailInboxSummary') {
  ...
  GetMailSummary() {
    ...
    var api1 = 'GmailCampaign/GmailAPIinboxSummary';
