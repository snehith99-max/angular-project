...
@Component({
  selector: 'app-crm-smm-outlookinboxsummary',
  templateUrl: './crm-smm-outlookinboxsummary.component.html',
  styleUrls: ['./crm-smm-outlookinboxsummary.component.scss']
})
export class CrmSmmOutlookinboxsummaryComponent  implements OnInit  {
  ...
  ngOnInit(): void {
    ...
    this.routerEventsSubscription = this.router.events.subscribe((event: any) => {
      if (event instanceof NavigationEnd) {
        ...
        if (event.url === '/crm/CrmSmmOutlookInboxSummary') {
          this.NgxSpinnerService.show();
        } else {
          this.NgxSpinnerService.show();
        }
  ...
  Onsubmit() {
    ...
    if (this.reactiveForm.value.appointment_timing != null &&
      ...
      this.NgxSpinnerService.show();
      var url = 'OutlookCampaign/PostcreateAppointment';
  ...
  GetMailSummary() {
    ...
    var api1 = 'OutlookCampaign/GmailAPIOutlookinboxSummary';
  ...
  selectEmail(email: Email) {
   ...
   this.seconds = this.selectedEmail.body;
    ...
    var url4 = 'OutlookCampaign/GetOutlookInboxCustomerDetails';
    ...
    if (this.selectedEmail.read_flag === 'false' || this.selectedEmail.read_flag === 'False' || this.selectedEmail.read_flag === '' || this.selectedEmail.read_flag === null) {
