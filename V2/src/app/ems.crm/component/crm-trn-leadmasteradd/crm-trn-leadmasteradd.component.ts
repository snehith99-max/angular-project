...
export class CrmTrnLeadmasteraddComponent implements OnInit {
  ...
  constructor(private renderer: Renderer2, private el: ElementRef, public service: SocketService, private ToastrService: ToastrService, private route: Router,private NgxSpinnerService: NgxSpinnerService,private router: ActivatedRoute) {
