...
@Component({
  selector: 'app-crm-trn-telecampaignmanagersummary',
  templateUrl: './crm-trn-telecampaignmanagersummary.component.html',
  styleUrls: ['./crm-trn-telecampaignmanagersummary.component.scss']
})
export class CrmTrnTelecampaignmanagersummaryComponent {
  ...
  ngOnInit(): void {
    ...
    this.reactiveFormfollow = new FormGroup({
      ...
      schedule_remarks: new FormControl(this.transfer.schedule_remarks, [
 ...
 getleadbankgid(parameter: string) {
  ...
  GetTelecallerManagerTotalSummary() {
    this.NgxSpinnerService.show();
    var url = 'TelecallerManager/GetTelecallerManagerTotalSummary'
    this.service.get(url).subscribe((result: any) => {
