...
@Component({
  selector: 'app-lgl-mst-casemanagement-view',
  templateUrl: './lgl-mst-casemanagement-view.component.html',
  styleUrls: ['./lgl-mst-casemanagement-view.component.scss']
})
export class LglMstCasemanagementViewComponent {
  groupedData: any;
  case_gid: any;
