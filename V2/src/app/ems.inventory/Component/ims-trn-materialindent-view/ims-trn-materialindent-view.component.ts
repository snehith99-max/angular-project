...
@Component({
  selector: 'app-ims-trn-materialindent-view',
  templateUrl: './ims-trn-materialindent-view.component.html',
  styleUrls: ['./ims-trn-materialindent-view.component.scss']
})
export class ImsTrnMaterialindentViewComponent {
