...
@Component({
  selector: 'app-ims-trn-sales-historyview',
  templateUrl: './ims-trn-sales-historyview.component.html',
  styleUrls: ['./ims-trn-sales-historyview.component.scss']
})
export class ImsTrnSalesHistoryviewComponent {
