...
@Component({
  selector: 'app-ims-trn-deliveryview',
  templateUrl: './ims-trn-deliveryview.component.html',
  styleUrls: ['./ims-trn-deliveryview.component.scss']
})
export class ImsTrnDeliveryviewComponent {
...
back(){
  this.route.navigate(['/ims/ImsTrnDeliveryOrderAcknowlegement']);
