...
@Component({
  selector: 'app-ims-rpt-movementview',
  templateUrl: './ims-rpt-movementview.component.html',
  styleUrls: ['./ims-rpt-movementview.component.scss']
})
export class ImsRptMovementviewComponent {
  ...
  GetStockStatementProduct(product_gid: any,branch_gid:any){
    ...
    var Api = 'ImsRptStockreport/GetStockmovementview';
