...
@Component({
  selector: 'app-ims-mst-product-edit',
  templateUrl: './ims-mst-product-edit.component.html',
  styleUrls: ['./ims-mst-product-edit.component.scss']
})
export class ImsMstProductEditComponent {
  product!: IProduct;
  defaultAuth: any = { }; 
  product_gid:any;
