...
@Component({
  selector: 'app-ims-mst-product-view',
  templateUrl: './ims-mst-product-view.component.html',
  styleUrls: ['./ims-mst-product-view.component.scss']
})
export class ImsMstProductViewComponent {
  product: any;
