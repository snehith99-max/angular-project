...
export class CrmMstProductEditComponent {
  ...
  GeteditProductSummary(product_gid: any) {
    ...
    this.service.getparams(url, param).subscribe((result: any) => {
      ...
      this.selectedproductunitclass = this.editProductSummary_list[0].productuom_gid;
      this.selectedunit = this.editProductSummary_list[0].productuomclass_gid;
  ...
  //     this.product.cost_price != null && this.product.mrp != null && this.product.product_desc != null) {

  //     console.log(this.productform.value)

  //     const api = 'EinvoiceProduct/UpdatedProduct';
