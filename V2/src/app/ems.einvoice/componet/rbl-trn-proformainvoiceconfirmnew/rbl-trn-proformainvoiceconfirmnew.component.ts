...
@Component({
  selector: 'app-rbl-trn-proformainvoiceconfirmnew',
  templateUrl: './rbl-trn-proformainvoiceconfirmnew.component.html',
  styleUrls: ['./rbl-trn-proformainvoiceconfirmnew.component.scss']
})
export class RblTrnProformainvoiceconfirmnewComponent {
