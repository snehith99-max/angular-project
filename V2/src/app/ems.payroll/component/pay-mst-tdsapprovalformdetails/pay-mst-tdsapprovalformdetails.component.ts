...
@Component({
  selector: 'app-pay-mst-tdsapprovalformdetails',
  templateUrl: './pay-mst-tdsapprovalformdetails.component.html',
  styleUrls: ['./pay-mst-tdsapprovalformdetails.component.scss']
})

export class PayMstTdsapprovalformdetailsComponent {
  parametervalue: any;
 ...
 allattchement: any[] = [];
  ...
  GetTDSdata() {
    ...
    this.service.getparams(api, param).subscribe((result: any) => {
      ...
      this.tdsinfoForm.get("section80C_i_name")?.setValue(this.tdsinfo.section80c_name1);
      this.tdsinfoForm.get("section80C_i_value")?.setValue(this.tdsinfo.section80c_grossamount1);
      this.tdsinfoForm.get("section80C_ii_name")?.setValue(this.tdsinfo.section80c_name2);
      this.tdsinfoForm.get("section80C_ii_value")?.setValue(this.tdsinfo.section80c_grossamount2);
      this.tdsinfoForm.get("section80C_iii_name")?.setValue(this.tdsinfo.section80c_name3);
      this.tdsinfoForm.get("section80C_iii_value")?.setValue(this.tdsinfo.section80c_grossamount3);
      this.tdsinfoForm.get("section80C_iv_name")?.setValue(this.tdsinfo.section80c_name4);
      this.tdsinfoForm.get("section80C_iv_value")?.setValue(this.tdsinfo.section80c_grossamount4);
      this.tdsinfoForm.get("section80C_v_name")?.setValue(this.tdsinfo.section80c_name5);
      this.tdsinfoForm.get("section80C_v_value")?.setValue(this.tdsinfo.section80c_grossamount5);
      this.tdsinfoForm.get("section80C_vi_name")?.setValue(this.tdsinfo.section80c_name6);
      this.tdsinfoForm.get("section80C_vi_value")?.setValue(this.tdsinfo.section80c_grossamount6);
      this.tdsinfoForm.get("section80C_vii_name")?.setValue(this.tdsinfo.section80c_name7);
      this.tdsinfoForm.get("section80C_vii_value")?.setValue(this.tdsinfo.section80c_grossamount7);
      this.tdsinfoForm.get("section80C_vii_gross_total")?.setValue(this.tdsinfo.section80c_amount7);
      this.tdsinfoForm.get("section80C_vii_deductable_total")?.setValue(this.tdsinfo.section80c_deductible_amount7);
      this.tdsinfoForm.get("section80CCC_gross_total")?.setValue(this.tdsinfo.section80ccc_grossamount);
      this.tdsinfoForm.get("section80CCC_deductable_total")?.setValue(this.tdsinfo.section80ccc_deductible_amount);
      this.tdsinfoForm.get("section80CCD_gross_total")?.setValue(this.tdsinfo.section80ccd_grossamount);
      this.tdsinfoForm.get("section80CCD_deductable_total")?.setValue(this.tdsinfo.section80ccd_deductible_amount);
      this.tdsinfoForm.get("aggregate3sec_gross_total")?.setValue(this.tdsinfo.aggregate_gross);
      this.tdsinfoForm.get("aggregate3sec_deductable_total")?.setValue(this.tdsinfo.aggregate_deduct);
      this.tdsinfoForm.get("section80CCD1B_gross_total")?.setValue(this.tdsinfo.section80ccd1b_grossamount);
      this.tdsinfoForm.get("section80CCD1B_deductable_total")?.setValue(this.tdsinfo.section80ccd1b_deductamount);
      this.tdsinfoForm.get("other_section1_value")?.setValue(this.tdsinfo.section1_name);
      this.tdsinfoForm.get("other_section1_gross_amount")?.setValue(this.tdsinfo.section1_grossamount);
      this.tdsinfoForm.get("other_section1_qualifying_amount")?.setValue(this.tdsinfo.section1_qualifiying_amount);
      this.tdsinfoForm.get("other_section1_deductable")?.setValue(this.tdsinfo.section1_deductible_amount);
      this.tdsinfoForm.get("other_section2_value")?.setValue(this.tdsinfo.section2_name);
      this.tdsinfoForm.get("other_section2_gross_amount")?.setValue(this.tdsinfo.section2_grossamount);
      this.tdsinfoForm.get("other_section2_qualifying_amount")?.setValue(this.tdsinfo.section2_qualifiying_amount);
      this.tdsinfoForm.get("other_section2_deductable")?.setValue(this.tdsinfo.section2_deductible_amount);
      this.tdsinfoForm.get("other_section3_value")?.setValue(this.tdsinfo.section3_name);
      this.tdsinfoForm.get("other_section3_gross_amount")?.setValue(this.tdsinfo.section3_grossamount);
      this.tdsinfoForm.get("other_section3_qualifying_amount")?.setValue(this.tdsinfo.section3_qualifiying_amount);
      this.tdsinfoForm.get("other_section3_deductable")?.setValue(this.tdsinfo.section3_deductible_amount);
      this.tdsinfoForm.get("other_section4_value")?.setValue(this.tdsinfo.section4_name);
      this.tdsinfoForm.get("other_section4_gross_amount")?.setValue(this.tdsinfo.section4_grossamount);
      this.tdsinfoForm.get("other_section4_qualifying_amount")?.setValue(this.tdsinfo.section4_qualifiying_amount);
      this.tdsinfoForm.get("other_section4_deductable")?.setValue(this.tdsinfo.section4_deductible_amount);
      this.tdsinfoForm.get("other_section5_value")?.setValue(this.tdsinfo.section5_name);
      this.tdsinfoForm.get("other_section5_gross_amount")?.setValue(this.tdsinfo.section5_grossamount);
      this.tdsinfoForm.get("other_section5_qualifying_amount")?.setValue(this.tdsinfo.section5_qualifiying_amount);
      this.tdsinfoForm.get("other_section5_deductable")?.setValue(this.tdsinfo.section5_deductible_amount);
      this.tdsinfoForm.get("aggregate4Asec_deductible_total")?.setValue(this.tdsinfo.aggregatedeductable_totalamount);
      this.tdsinfoForm.get("total_taxable_income")?.setValue(this.tdsinfo.total_income);
      this.tdsinfoForm.get("tax_on_total_income")?.setValue(this.tdsinfo.tax_total_income);
      this.tdsinfoForm.get("educationcess")?.setValue(this.tdsinfo.educationcess_amount);
      this.tdsinfoForm.get("tax_payable")?.setValue(this.tdsinfo.tax_payable12plus13);
      this.tdsinfoForm.get("less_relief")?.setValue(this.tdsinfo.less_relief89);
      this.tdsinfoForm.get("net_tax_payable")?.setValue(this.tdsinfo.tax_payable14minus15);
      this.tdsinfoForm.get("less_tax_deducted_at_source")?.setValue(this.tdsinfo.less_tds);
      this.tdsinfoForm.get("balance_tax_pay_refund")?.setValue(this.tdsinfo.balance_tax);
    });
  }

  submittdsdetails() {
    debugger
    var api = 'PayMstTDSapproval/PostTDSApprove';
  ...
  back() {
    this.router.navigate(['/payroll/PayMstTDSApproval'])
  }
}
