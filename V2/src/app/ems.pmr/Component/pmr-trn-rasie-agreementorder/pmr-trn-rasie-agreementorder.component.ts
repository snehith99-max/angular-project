...
// @Component({
//   selector: 'app-pmr-trn-rasie-agreementorder',
//   templateUrl: './pmr-trn-rasie-agreementorder.component.html',
//   styleUrls: ['./pmr-trn-rasie-agreementorder.component.scss']
// })
// export class PmrTrnRasieAgreementorderComponent {
...
export class PmrTrnRasieAgreementorderComponent {
  ...
  ondelete() {
    ...
    this.service.getparams(url, param).subscribe((result: any) => {
      if (result.status == false) {
        ...
        // Call POAproductsummary() directly if it is synchronous
        this.POAproductsummary();

        // Call OnChangeTaxAmount4() after POAproductsummary()
        this.OnChangeTaxAmount4(); 
        this.OnClearOverallTax();
  ...
  onSubmit() {
    ...
    if (
      ...
      var api = 'PmrTrnPurchaseagreement/ProductSubmit';
      this.NgxSpinnerService.show()
