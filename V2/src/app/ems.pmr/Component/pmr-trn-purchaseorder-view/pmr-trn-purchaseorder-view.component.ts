...
export class PmrTrnPurchaseorderViewComponent {
  ...
  GetViewPurchaseOrderSummary(purchaseorder_gid: any) {
    ...
    this.renewal_type=this.purchaseorder_list[0].renewal_date;
    this.frequency_term=this.purchaseorder_list[0].frequency_term;
    this.file_path=this.purchaseorder_list[0].file_path;
    this.file_name=this.purchaseorder_list[0].file_name;
