...
@Component({
  selector: 'app-pmr-trn-operationpoapproval',
  templateUrl: './pmr-trn-operationpoapproval.component.html',
  styleUrls: ['./pmr-trn-operationpoapproval.component.scss'],
  styles: [`
  table thead th, 
  .table tbody td { 
   position: relative; 
...
export class PmrTrnOperationpoapprovalComponent{
  ...
  GetPurchaseOrderSummary(){
    ...
    var url = 'PmrTrnPurchaseOrder/GetOpertionalApprovalSummary'
  ...
  onview(params:any){
    ...
    this.router.navigate(['/pmr/PmrTrnOperationpoapprovalview',encryptedParam])
