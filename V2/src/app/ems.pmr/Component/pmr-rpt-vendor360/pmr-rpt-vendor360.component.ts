...
@Component({
  selector: 'app-pmr-rpt-vendor360',
  templateUrl: './pmr-rpt-vendor360.component.html',
  styleUrls: ['./pmr-rpt-vendor360.component.scss']
})
export class PmrRptVendor360Component {
  ...
  onback() {
      this.router.navigate(['/pmr/PmrRptVendorLedgerreport']);
    }
  // vendor details
