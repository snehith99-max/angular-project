...
@Component({
  selector: 'app-pmr-trn-operationpoapprovalview',
  templateUrl: './pmr-trn-operationpoapprovalview.component.html',
  styleUrls: ['./pmr-trn-operationpoapprovalview.component.scss']
})
export class PmrTrnOperationpoapprovalviewComponent {
  ...
  constructor(private formBuilder: FormBuilder,
     private route: Router, private router: ActivatedRoute,
      public service: SocketService, private ToastrService: ToastrService) {
  ...
  onSubmit() {
    var approvalapi = 'PmrTrnPurchaseOrder/OperationalApprovalPO';
    let param = {
    ...
    this.service.getparams(approvalapi, param).subscribe((result: any) => {
      if (result.status == false) {
        ...
        this.route.navigate(['/pmr/PmrTrnOperationpoapproval']);
      }
    });
  }
  onreject(){
