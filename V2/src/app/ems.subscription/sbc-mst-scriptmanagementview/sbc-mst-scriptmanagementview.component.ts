...
@Component({
  selector: 'app-sbc-mst-scriptmanagementview',
  templateUrl: './sbc-mst-scriptmanagementview.component.html',
  styleUrls: ['./sbc-mst-scriptmanagementview.component.scss']
})
export class SbcMstScriptmanagementviewComponent {
  script_list:any;
  responsedata:any;
employee:any;
  ...
  GetScriptViewsummary(dbscriptmanagementdocument_gid: any) {
    debugger
    var url = 'Scriptmanagement/GetScriptViewSummary'
    debugger
    let param = {
      dbscriptmanagementdocument_gid: dbscriptmanagementdocument_gid
    }
    this.service.getparams(url, param).subscribe((result: any) => {
      this.script_list = result.serverlists;
    });
  }
}
