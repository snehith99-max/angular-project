...
debugger
    ...
    this.quote = this.route.snapshot.paramMap.get('enquiry_gid');
    ...
    this.GetQOSummary(this.enq_gid);
    ...
    this.service.get(api).subscribe((result: any) => {
      ...
      if (this.allchargeslist[0].flag == 'Y') {
        ...
        // this.addoncharge = this.allchargeslist[0].flag;
        this.QuoteAddForm.get("addoncharge")?.setValue(0);
      }
      ...
      if (this.allchargeslist[1].flag == 'Y') {
        ...
        // this.additional_discount = this.allchargeslist[1].flag;
        this.QuoteAddForm.get("additional_discount")?.setValue(0);
      }
      ...
      if (this.allchargeslist[2].flag == 'Y') {
        ...
        // this.freight_charges = this.allchargeslist[2].flag;
        this.QuoteAddForm.get("freight_charges")?.setValue(0);
      }
  ...
  GetQOSummary(enquiry_gid: any) {
    var url = 'SmrEnquiryToQuotation/GetEnquiryQuotationSummary'
    ...
    this.service.getparams(url, param).subscribe((result: any) => {
      ...
      this.EnquiryQuotationlist = result.EnquiryQuotationlist;
      this.QuoteAddForm.get("enquiry_gid")?.setValue(this.enq_gid);
      this.QuoteAddForm.get("customer_gid")?.setValue(this.EnquiryQuotationlist[0].customer_gid);
      this.QuoteAddForm.get("quotation_referenceno1")?.setValue(this.EnquiryQuotationlist[0].quotation_referenceno1);
      this.QuoteAddForm.get("quotation_date")?.setValue(this.EnquiryQuotationlist[0].quotation_date);
      this.QuoteAddForm.get("branch_name")?.setValue(this.EnquiryQuotationlist[0].branch_gid);
      this.QuoteAddForm.get("customer_name")?.setValue(this.EnquiryQuotationlist[0].customer_name);
      this.QuoteAddForm.get("customer_contact")?.setValue(this.EnquiryQuotationlist[0].customer_contact);
      this.QuoteAddForm.get("enquiry_referencenumber")?.setValue(this.EnquiryQuotationlist[0].enquiry_referencenumber);
      this.QuoteAddForm.get("mobile")?.setValue(this.EnquiryQuotationlist[0].customer_mobile);
      this.QuoteAddForm.get("email")?.setValue(this.EnquiryQuotationlist[0].customer_email);
      this.QuoteAddForm.get("address1")?.setValue(this.EnquiryQuotationlist[0].customer_address);
      this.QuoteAddForm.get("quotation_remarks")?.setValue(this.EnquiryQuotationlist[0].so_remarks);
      this.QuoteAddForm.get("gst_number")?.setValue(this.EnquiryQuotationlist[0].gst_number);
      this.QuoteAddForm.get("taxsegment_name")?.setValue(this.EnquiryQuotationlist[0].taxsegment_gid);
      this.QuoteAddForm.get("pricesegment_name")?.setValue(this.EnquiryQuotationlist[0].pricesegment_gid);
      this.QuoteAddForm.get("city")?.setValue(this.EnquiryQuotationlist[0].city);
      this.QuoteAddForm.get("zip_code")?.setValue(this.EnquiryQuotationlist[0].customer_pin);
      this.QuoteAddForm.get("region_name")?.setValue(this.EnquiryQuotationlist[0].customer_region);
      this.QuoteAddForm.get("countryname")?.setValue(this.EnquiryQuotationlist[0].country_gid);
      this.mdlSalesName=this.EnquiryQuotationlist[0].user_name;
      // this.quotationform.get("currency_code")?.setValue(this.EnquiryQuotationlist[0].currency_code);
      // this.quotationform.get("exchange_rate")?.setValue(this.EnquiryQuotationlist[0].exchange_rate);
      // this.quotationform.get("grandtotal")?.setValue(this.EnquiryQuotationlist[0].grandtotal);
      // this.quotationform.get("producttotalamount")?.setValue(this.EnquiryQuotationlist[0].producttotalamount);
      this.responsedata=result.EnquiryQuotationTemp;
      this.GetTempSummary();
  ...
  GetTempSummary() {
    ...
    var url = 'SmrEnquiryToQuotation/GetEnquirytoQuotationTempSummary'
    this.service.getparams(url, params).subscribe((result: any) => {

      this.responsedata = result;
      this.EnqtoQuote_list = this.responsedata.temp_list1;


      this.QuoteAddForm.get("producttotalamount")?.setValue(result.grand_total);
      this.QuoteAddForm.get("grandtotal")?.setValue(result.grand_total);
      this.QuoteAddForm.get("product_gid")?.setValue(result.product_gid);

      this.EnqtoQuote_list.forEach((product: any) => {
  ...
  OnChangeCustomer() {
    let customercontact_gid = this.QuoteAddForm.value.customer_name.customer_gid;
    let param = {
  ...
  OnChangeTaxAmount4() {
    ...
    this.taxpercentage = this.getDimensionsByFilter(tax_gid);
    let tax_percentage = this.taxpercentage[0].percentage;
    this.tax_amount4 = +(tax_percentage * this.totalamount / 100).toFixed(2);
    this.total_amount = +((+this.totalamount) + (+this.tax_amount4));
  ...
  onSubmit() {
    ...
    if (this.EnqtoQuote_list == null || this.EnqtoQuote_list == undefined) {
      window.scrollTo({
        top: 0,
      });
    ...
    var params = {
      ...
      customer_gid: this.QuoteAddForm.value.customer_gid,
      ...
      total_amount: this.QuoteAddForm.value.producttotalamount,
...
console.log(params)
    var url = 'SmrEnquiryToQuotation/PostEnquirytoQuotation'
    this.NgxSpinnerService.show()
  ...
  handleTaxSegments(product_gid: string, taxSegments: any[]) {
    ...
    if (productTaxSegments.length > 0) {
      ...
      this.EnqtoQuote_list.forEach((product: { product_gid: string; taxSegments: any[]; }) => {
