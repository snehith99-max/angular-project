...
@Component({
  selector: 'app-smr-trn-renewalto-invoice',
  templateUrl: './smr-trn-renewalto-invoice.component.html',
  styleUrls: ['./smr-trn-renewalto-invoice.component.scss']
})
export class SmrTrnRenewaltoInvoiceComponent {
  ...
  ngOnInit(): void {
    ...
    const deencryptedParam = AES.decrypt(this.renewal_gid,secretKey).toString(enc.Utf8);
     this.GetInvoiceSummary(deencryptedParam);
...
async GetInvoiceSummary(renewal_gid: any) {
  debugger
this.NgxSpinnerService.show();
    let param = { renewal_gid: renewal_gid }
    var summaryapi = 'SmrTrnRenewalsummary/GetrenewalToinvoiceDetailsSummary';
    this.service.getparams(summaryapi, param).subscribe((apiresponse: any) => {
    this.Getrenewaltoinvoice_list = apiresponse.Getrenewaltoinvoice_list;
    this.combinedFormData.get('branch_name')?.setValue(this.Getrenewaltoinvoice_list[0].branch_name);
    this.combinedFormData.get('branch_gid')?.setValue(this.Getrenewaltoinvoice_list[0].branch_gid);
    this.combinedFormData.get('customer_name')?.setValue(this.Getrenewaltoinvoice_list[0].customer_name);
    this.combinedFormData.get('customer_email')?.setValue(this.Getrenewaltoinvoice_list[0].customer_email);
    this.combinedFormData.get('customercontact_names')?.setValue(this.Getrenewaltoinvoice_list[0].customercontact_names);
    this.combinedFormData.get('customer_address')?.setValue(this.Getrenewaltoinvoice_list[0].customer_address);
    this.combinedFormData.get('payment_terms')?.setValue(this.Getrenewaltoinvoice_list[0].payment_terms);
    this.combinedFormData.get('freight_terms')?.setValue(this.Getrenewaltoinvoice_list[0].freight_terms);
    this.combinedFormData.get('currency_code')?.setValue(this.Getrenewaltoinvoice_list[0].currency_code);
    this.combinedFormData.get('exchange_rate')?.setValue(this.Getrenewaltoinvoice_list[0].exchange_rate);
    this.combinedFormData.get('user_name')?.setValue(this.Getrenewaltoinvoice_list[0].user_name);
    this.combinedFormData.get('addon_charge')?.setValue(this.Getrenewaltoinvoice_list[0].addon_amount);
    this.combinedFormData.get('freight_charges')?.setValue(this.Getrenewaltoinvoice_list[0].freight_charges);
    this.combinedFormData.get('packing_charges')?.setValue(this.Getrenewaltoinvoice_list[0].packing_charges);
    this.combinedFormData.get('insurance_charges')?.setValue(this.Getrenewaltoinvoice_list[0].insurance_charges);
    this.combinedFormData.get('additional_discount')?.setValue(this.Getrenewaltoinvoice_list[0].discount_amount);
    this.combinedFormData.get('delivery_days')?.setValue(this.Getrenewaltoinvoice_list[0].delivery_days);
    this.combinedFormData.get('payment_days')?.setValue(this.Getrenewaltoinvoice_list[0].payment_days);
    this.combinedFormData.get('so_remarks')?.setValue(this.Getrenewaltoinvoice_list[0].so_remarks);
    this.combinedFormData.get('roundoff')?.setValue(this.Getrenewaltoinvoice_list[0].roundoff);
    this.combinedFormData.get('tax_amount4')?.setValue(this.Getrenewaltoinvoice_list[0].tax_amount);
    this.combinedFormData.get('tax_name4')?.setValue(this.Getrenewaltoinvoice_list[0].tax_name);
    this.combinedFormData.get('shipping_to')?.setValue(this.Getrenewaltoinvoice_list[0].shipping_to);
    this.combinedFormData.get('renewal_gid')?.setValue(this.Getrenewaltoinvoice_list[0].renewal_gid);
    this.combinedFormData.get('renewal_gid')?.setValue(this.Getrenewaltoinvoice_list[0].renewal_gid);
    


    this.termsandconditions = this.Getrenewaltoinvoice_list[0].termsandconditions;
    this.customer_gid = this.Getrenewaltoinvoice_list[0].customer_gid;
    this.branch_gid = this.Getrenewaltoinvoice_list[0].branch_gid;
    const customer_mobile = this.Getrenewaltoinvoice_list[0].customer_mobile;
        const customer_email = this.Getrenewaltoinvoice_list[0].email;
        const gst_number = this.Getrenewaltoinvoice_list[0].gst_number;
        const customerDetails = `${customer_mobile}\n${customer_email}\n${gst_number}`;
        this.combinedFormData.get("customer_details")?.setValue(customerDetails);
    });    
    this.OrdertoInvoiceSummary(renewal_gid);
    this.NgxSpinnerService.hide();
  } 
async  OrdertoInvoiceSummary(renewal_gid: any){
    let param = { renewal_gid : renewal_gid}
    this.NgxSpinnerService.show();
    var productsummaryapi = 'SmrTrnRenewalsummary/GetrenewalToInvoiceProductSummary';
    ...
    this.OrdertoInvoiceproductSummary(renewal_gid);
    });
    this.NgxSpinnerService.hide();
  }
  onClearCurrency() {
...
onSubmit() {
  debugger
    var params = {
      ...
      renewal_gid: this.combinedFormData.value.renewal_gid,
    ...
    var url = 'SmrTrnRenewalsummary/PostOnsubmitrenewaltoInvoice'
    this.NgxSpinnerService.show();
  ...
  productAddSubmit() {
    ...
    var postapi = 'SmrTrnRenewalsummary/PostrenewalToInvoiceProductAdd';
    this.NgxSpinnerService.show();
  ...
  OrdertoInvoiceproductSummary(renewal_gid:any) {
    this.NgxSpinnerService.show();
   let param ={ renewal_gid : renewal_gid}
    var api = 'SmrTrnRenewalsummary/GetrenewalToInvoiceProductDetails';
