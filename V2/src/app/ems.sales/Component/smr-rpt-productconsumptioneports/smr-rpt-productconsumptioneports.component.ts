...
@Component({
  selector: 'app-smr-rpt-productconsumptioneports',
  templateUrl: './smr-rpt-productconsumptioneports.component.html',
  styleUrls: ['./smr-rpt-productconsumptioneports.component.scss']
})
export class SmrRptProductconsumptioneportsComponent {
...
GetProductConsumptionReport() {
  ...
  var url = 'product_reports/GetProductConsumptionReport'
...
Details(product_gid: any){
  ...
  var url = 'product_reports/GetProductReportgrid'
  let param = {
