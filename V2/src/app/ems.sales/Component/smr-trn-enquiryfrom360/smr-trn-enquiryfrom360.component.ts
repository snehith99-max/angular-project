...
@Component({
  selector: 'app-smr-trn-enquiryfrom360',
  templateUrl: './smr-trn-enquiryfrom360.component.html',
  styleUrls: ['./smr-trn-enquiryfrom360.component.scss']
})
export class SmrTrnEnquiryfrom360Component {
     ...
     this.showAddButton = true;
          ...
          this.service.postparams(url, params).subscribe((result: any) => {
            ...
            if (result.status == false) {
              ...
              const leadbank_gid = AES.encrypt(this.leadbank_gid, secretKey).toString();
               this.router.navigate(['/smr/SmrTrnSales360', leadbank_gid,this.leadbankcontact_gid,this.lead2campaign_gid,this.lspage ]);
               this.NgxSpinnerService.hide()
      ...
      onclose() {
        ...
        if (this.lspage1 == 'Total') {
          this.router.navigate(['/smr/SmrTrnSales360', leadbank_gid, this.lead2campaign_gid,this.leadbankcontact_gid, this.lspage]);
          this.NgxSpinnerService.hide()
        }
        else {
