...
@Component({
  selector: 'app-smr-trn-raisesalesordernew360',
  templateUrl: './smr-trn-raisesalesordernew360.component.html',
  styleUrls: ['./smr-trn-raisesalesordernew360.component.scss']
})
export class SmrTrnRaisesalesordernew360Component {
  ...
  ngOnInit(): void {
    ...
    //console.log('eoxnel', deencryptedParam)
    const appointment_gid = this.router.snapshot.paramMap.get('appointment_gid');
    ...
    this.OnChangeCustomer(deencryptedParam);
    this.productSearch();
    ...
    this.service.get(url).subscribe((result: any) => {
      ...
      this.customer_list = this.customer_list.filter((item: any) => item.customer_gid == deencryptedParam);
      console.log('erihnek', this.customer_list);
      this.mdlCustomerName = this.customer_list[0].customer_name;
    });
  ...
  OnChangeCustomer(deencryptedParam: any) {
    let customer_gid = deencryptedParam;
    let param = {
    ...
    this.service.getparams(url, param).subscribe((result: any) => {
      this.responsedata = result;
      console.log('oimlkc', this.responsedata)
  ...
  onSubmit() {
    var params = {
      customer_gid: this.customer_list[0].customer_gid,
      ...
      customer_name: this.mdlCustomerName,
