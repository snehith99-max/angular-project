...
@Component({
  selector: 'app-smr-rpt-detailcommission-report',
  templateUrl: './smr-rpt-detailcommission-report.component.html',
  styleUrls: ['./smr-rpt-detailcommission-report.component.scss']
})
export class SmrRptDetailcommissionReportComponent {
  responsedata: any;
