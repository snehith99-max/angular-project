...
@Component({
  selector: 'app-smr-trn-quotationadd-new',
  templateUrl: './smr-trn-quotationadd-new.component.html',
  styleUrls: ['./smr-trn-quotationadd-new.component.scss']
})
export class SmrTrnQuotationaddNewComponent {
...
debugger
  ...
  OnChangeCustomer() {
    ...
    if (this.decryt_customer_gid != null && this.decryt_appointment_gid != null) {
      ...
      this.customer_gid = AES.decrypt(this.decryt_customer_gid, secretKey).toString(enc.Utf8);
      param = {
        customercontact_gid:this.customer_gid
      }
    }
    else {
    ...
    this.service.getparams(url, param).subscribe((result: any) => {
      ...
      this.QuoteAddForm.get("customer_gid")?.setValue(result.GetCustomerdetls[0].customer_gid);
  ...
  Quoteproductsummary() {
    debugger;
    let customercontact_gid = this.QuoteAddForm.value.customer_gid;
  ...
  prodcutaddtotalcal() {
    ...
    if (this.decryt_customer_gid != null && this.decryt_appointment_gid != null) {
      ...
      customer = this.QuoteAddForm.value.customer_gid;
    }
