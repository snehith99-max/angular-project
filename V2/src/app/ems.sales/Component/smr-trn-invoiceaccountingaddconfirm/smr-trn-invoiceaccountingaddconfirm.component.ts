...
@Component({
  selector: 'app-smr-trn-invoiceaccountingaddconfirm',
  templateUrl: './smr-trn-invoiceaccountingaddconfirm.component.html',
  styleUrls: ['./smr-trn-invoiceaccountingaddconfirm.component.scss']
})

export class SmrTrnInvoiceaccountingaddconfirmComponent {
...
debugger;
  ...
  back1() {
    this.router.navigate(['/smr/SalesInvoiceSummary']);
  }
