...
@Component({
  selector: 'app-smr-rpt-productgroupreport',
  templateUrl: './smr-rpt-productgroupreport.component.html',
  styleUrls: ['./smr-rpt-productgroupreport.component.scss']
})
export class SmrRptProductgroupreportComponent {
  ...
  GetProductGroupwiseChart(){
    ...
    debugger
    var url = 'product_reports/GetProductGroupwiseChart'
  ...
  onSearchClick(){
    ...
    var url= 'product_reports/GetProductGroupwiseChartSearch';
    let params ={
