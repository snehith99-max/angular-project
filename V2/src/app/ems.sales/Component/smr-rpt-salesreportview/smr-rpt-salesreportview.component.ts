...
@Component({
  selector: 'app-smr-rpt-salesreportview',
  templateUrl: './smr-rpt-salesreportview.component.html',
  styleUrls: ['./smr-rpt-salesreportview.component.scss']
})
export class SmrRptSalesreportviewComponent {
