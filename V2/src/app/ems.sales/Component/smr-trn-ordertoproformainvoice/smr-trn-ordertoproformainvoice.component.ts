...
@Component({
  selector: 'app-smr-trn-ordertoproformainvoice',
  templateUrl: './smr-trn-ordertoproformainvoice.component.html',
  styleUrls: ['./smr-trn-ordertoproformainvoice.component.scss']
})


export class SmrTrnOrdertoproformainvoiceComponent {
...
this.NgxSpinnerService.show();
    ...
    this.combinedFormData.get('customer_email')?.setValue(this.Getordertoinvoice_list[0].email);
    this.combinedFormData.get('customercontact_names')?.setValue(this.Getordertoinvoice_list[0].customercontact_name);
    ...
    this.combinedFormData.get('customer_mobile')?.setValue(this.Getordertoinvoice_list[0].customer_mobile);
  ...
  onSubmit() {
    ...
    var params = {
      ...
      freight_terms: this.combinedFormData.value.delivery_days,
      payment_terms: this.combinedFormData.value.payment_days,
    ...
    console.log(params)
    var url = 'SmrTrnProformaInvoice/ProformaInvoiceSubmit'
    this.NgxSpinnerService.show();
