...
// @Component({
//   selector: 'app-smr-trn-raise-agreement',
//   templateUrl: './smr-trn-raise-agreement.component.html',
//   styleUrls: ['./smr-trn-raise-agreement.component.scss']
// })
// export class SmrTrnRaiseAgreementComponent {
...
export class SmrTrnRaiseAgreementComponent {
  ...
  ngOnInit(): void {
    ...
    this.combinedFormData = new FormGroup({
      ...
      agreement_date: new FormControl(this.getCurrentDate()),
  ...
  onSubmit() {
    ...
    var url = 'SmrTrnRenewalsummary/PostAgreementOrder'
  ...
  productAddSubmit() {
    ...
    var postapi = 'SmrTrnRenewalsummary/PosttempProductAdd';
    this.NgxSpinnerService.show();
    let param = {
  ...
  productSearch() {
    var api = 'SmrTrnRenewalsummary/GetProductsearchSummary';
    this.service.get(api).subscribe((result: any) => {
      this.responsedata = result;
      this.SOProductList = this.responsedata.GetProductsearchs1;
