...
@Component({
  selector: 'app-smr-trn-quoteeditnew',
  templateUrl: './smr-trn-quoteeditnew.component.html',
  styleUrls: ['./smr-trn-quoteeditnew.component.scss']
})
export class SmrTrnQuoteeditnewComponent {
  ...
  ngOnInit(): void {
    ...
    this.Quoteproductsummary(deencryptedParam);
    ...
    //     this.QuoteAddForm.get("addoncharge")?.setValue(this.quotationsummary_list[0].addon_charge);
    //   } else {
    //     this.QuoteAddForm.get("addoncharge")?.setValue(this.quotationsummary_list[0].addon_charge);
    //   }

    //   if (this.allchargeslist[1].flag == 'Y') {
    //     this.QuoteAddForm.get("additional_discount")?.setValue(this.quotationsummary_list[0].additional_discount);
    //   } else {
    //     // this.additional_discount = this.allchargeslist[1].flag;
    //     this.QuoteAddForm.get("additional_discount")?.setValue(this.quotationsummary_list[0].additional_discount);
    //   }
    ...
    //     this.QuoteAddForm.get("freight_charges")?.setValue(this.quotationsummary_list[0].freight_charges);
    //   } else {
    //     // this.freight_charges = this.allchargeslist[2].flag;
    //     this.QuoteAddForm.get("freight_charges")?.setValue(this.quotationsummary_list[0].freight_charges);
    //   }
    ...
    this.GetEditSalesOrder(deencryptedParam);
    
  }
  GetEditSalesOrder(params:any){
    var url='SmrTrnQuotation/GetEditQuoteProdSummary'
    let param = {
      quotation_gid : params 
    }
    this.service.getparams(url,param).subscribe((result:any)=>{
    this.responsedata=result;
    this.quotationedit_list = result.postquotation_list;
    this.Quoteproductsummary(this.quotation_gid);
    });
  }
  GetViewQuotationSummary(quotation_gid: any) {
  
    var url='SmrTrnQuotation/GetEditQuotationSummary'
    let param = {
    ...
    this.service.getparams(url, param).subscribe((result: any) => {
      ...
      this.QuoteAddForm.get("customer_gid")?.setValue(this.quotationsummary_list[0].customer_gid)
      this.QuoteAddForm.get("quotation_date")?.setValue(this.quotationsummary_list[0].quotation_date)
      this.QuoteAddForm.get("quotation_referenceno1")?.setValue(this.quotationsummary_list[0].quotation_gid)
      this.QuoteAddForm.get("customer_name")?.setValue(this.quotationsummary_list[0].customer_name)
      this.QuoteAddForm.get("mobile")?.setValue(this.quotationsummary_list[0].contact_no)
      this.QuoteAddForm.get("email")?.setValue(this.quotationsummary_list[0].contact_mail)
      this.QuoteAddForm.get("gst_number")?.setValue(this.quotationsummary_list[0].gst_number)
      this.QuoteAddForm.get("taxsegment_name")?.setValue(this.quotationsummary_list[0].taxsegment_name)
      this.QuoteAddForm.get("pricesegment_name")?.setValue(this.quotationsummary_list[0].pricesegment_name)
      this.QuoteAddForm.get("address1")?.setValue(this.quotationsummary_list[0].address1)
      this.QuoteAddForm.get("address2")?.setValue(this.quotationsummary_list[0].address2)
      this.QuoteAddForm.get("city")?.setValue(this.quotationsummary_list[0].customer_city)
      this.QuoteAddForm.get("zip_code")?.setValue(this.quotationsummary_list[0].customer_pin)
      this.QuoteAddForm.get("country_name")?.setValue(this.quotationsummary_list[0].country_name)
      this.QuoteAddForm.get("region_name")?.setValue(this.quotationsummary_list[0].region_name)
      this.QuoteAddForm.get("user_name")?.setValue(this.quotationsummary_list[0].salesperson_name)
      this.QuoteAddForm.get("delivery_days")?.setValue(this.quotationsummary_list[0].delivery_days)
      this.QuoteAddForm.get("payment_days")?.setValue(this.quotationsummary_list[0].payment_days)
      this.QuoteAddForm.get("quotation_remarks")?.setValue(this.quotationsummary_list[0].quotation_remarks)
      this.QuoteAddForm.get("currency_code")?.setValue(this.quotationsummary_list[0].currency_code)
      this.QuoteAddForm.get("exchange_rate")?.setValue(this.quotationsummary_list[0].exchange_rate)
      this.QuoteAddForm.get("totalamount")?.setValue(this.quotationsummary_list[0].total_amount);
      this.QuoteAddForm.get("tax_name4")?.setValue(this.quotationsummary_list[0].tax_name);
      this.QuoteAddForm.get("tax_amount4")?.setValue(this.quotationsummary_list[0].tax_amount4);
      this.QuoteAddForm.get("addoncharge")?.setValue(this.quotationsummary_list[0].addon_charge);
      this.QuoteAddForm.get("additional_discount")?.setValue(this.quotationsummary_list[0].additional_discount);
      this.QuoteAddForm.get("freight_charges")?.setValue(this.quotationsummary_list[0].freight_charges);
      this.QuoteAddForm.get("buyback_charges")?.setValue(this.quotationsummary_list[0].buyback_charges);
      this.QuoteAddForm.get("packing_charges")?.setValue(this.quotationsummary_list[0].packing_charges);
      this.QuoteAddForm.get("insurance_charges")?.setValue(this.quotationsummary_list[0].insurance_charges);
      this.QuoteAddForm.get("roundoff")?.setValue(this.quotationsummary_list[0].roundoff);
      this.QuoteAddForm.get("grandtotal")?.setValue(this.quotationsummary_list[0].total_price);
      this.QuoteAddForm.get("zip_code")?.setValue(this.quotationsummary_list[0].pincode)
      this.QuoteAddForm.get("template_content")?.setValue(this.quotationsummary_list[0].termsandconditions)
  ...
  OnChangeCustomer() {
    debugger
    let customercontact_gid = this.QuoteAddForm.value.customer_name;
    let param = {
  ...
  productAddSubmit() {
    if(this.productquantity == null || this.productquantity == undefined || this.productquantity == 0 ) {
      debugger
      window.scrollTo({
        top: 0,
      });
  ...
  OnChangeCurrency() {
    debugger;
    let currency_code = this.QuoteAddForm.get("currency_code")?.value;
    let param = {
      currency_code: currency_code
    }
    var url = 'SmrTrnQuotation/GetOnChangeCurrencyexhange';
    this.service.getparams(url, param).subscribe((result: any) => {
      this.responsedata = result;
  ...
  onSubmit() {
    ...
    var params = {
      ...
      customer_gid: this.QuoteAddForm.value.customer_name.customer_gid,
    ...
    console.log(params)
    var url = 'SmrTrnQuotation/PostUpdateQuotation'
    this.NgxSpinnerService.show()
  ...
  Quoteproductsummary(quotation_gid:any) {
    debugger;
    //let quotation_gid = this.QuoteAddForm.value.quotation_gid;
    var api = 'SmrTrnQuotation/GetEditTempProdSummary';
    let param = {
      quotation_gid:quotation_gid
    }
  ...
  prodcutaddtotalcal() {
    ...
    const customer = this.QuoteAddForm.value.customer_gid;
