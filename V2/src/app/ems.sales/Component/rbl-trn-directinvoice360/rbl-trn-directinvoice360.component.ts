...
@Component({
  selector: 'app-rbl-trn-directinvoice360',
  templateUrl: './rbl-trn-directinvoice360.component.html',
  styleUrls: ['./rbl-trn-directinvoice360.component.scss']
})
export class RblTrnDirectinvoice360Component {
  ...
  OnChangeCustomer(parameter:any) {

    let customer_gid = parameter;
    let param = {
...
console.log('oo',  this.GetCustomerDet)
