...
@Component({
  selector: 'app-smr-trn-invoiceraise',
  templateUrl: './smr-trn-invoiceraise.component.html',
  styleUrls: ['./smr-trn-invoiceraise.component.scss']
})
export class SmrTrnInvoiceraiseComponent {
  ...
  invoiceaccounting(params: any,param1:any,param2:any) {
    ...
    const lspage = "SmrRptInvoicereport";



    const encryptedParam = AES.encrypt(param, secretKey).toString();
    this.router.navigate(['/smr/Invoiceaccountingaddconfirm', encryptedParam,leadbank_gid,lead2campaign_gid,lspage])
  }
  redirecttolist(){
    this.router.navigate(['/smr/SmrRptInvoicereport'])
  }
