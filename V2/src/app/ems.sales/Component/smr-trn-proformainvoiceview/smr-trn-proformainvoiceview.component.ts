...
@Component({
  selector: 'app-smr-trn-proformainvoiceview',
  templateUrl: './smr-trn-proformainvoiceview.component.html',
   styleUrls: ['./smr-trn-proformainvoiceview.component.scss']
})
export class SmrTrnProformainvoiceviewComponent {
  ...
  summary(invoice_gid: any) {
    debugger;
    var url = 'SmrTrnProformaInvoice/GetProformaInvoiceViewdata'
  ...
  prodsummary(invoice_gid: any) {
    debugger;
    var url = 'SmrTrnProformaInvoice/GetProformaInvoiceProductsEditdata'
    let param = { invoice_gid: invoice_gid }
    this.service.getparams(url, param).subscribe((result: any) => {
      this.responsedata = result;
