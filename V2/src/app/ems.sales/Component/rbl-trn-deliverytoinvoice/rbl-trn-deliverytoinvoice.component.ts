...
@Component({
  selector: 'app-rbl-trn-deliverytoinvoice',
  templateUrl: './rbl-trn-deliverytoinvoice.component.html',
  styleUrls: ['./rbl-trn-deliverytoinvoice.component.scss']
})
export class RblTrnDeliverytoinvoiceComponent {
  ...
  taxgid1tmp:any;
  taxamount1tmp:any;
  taxprecentage1tmp:any;
  taxsegment_gidtmp:any;
  taxname1tmp:any;
  mdlproductName: any;
  responsedata: any;
  ExchangeRate: any;  
  ...
  ngOnInit(): void {
    ...
    this.combinedFormData = new FormGroup({            
      ...
      buyback_charges1: new FormControl(''),
      insurance_charges: new FormControl(''),
      insurance_charges1: new FormControl(''),
      roundoff: new FormControl(''),
      roundoff1: new FormControl(''),
      grandtotal: new FormControl(''),
      packing_charges: new FormControl(''),
      packing_charges1: new FormControl(''),
...
this.NgxSpinnerService.show();
    ...
    this.combinedFormData.get('addon_charge1')?.setValue(this.Getordertoinvoice_list[0].addon_amount);
    this.combinedFormData.get('freight_charges1')?.setValue(this.Getordertoinvoice_list[0].freight_charges);
    this.combinedFormData.get('packing_charges1')?.setValue(this.Getordertoinvoice_list[0].packing_charges);
    this.combinedFormData.get('insurance_charges1')?.setValue(this.Getordertoinvoice_list[0].insurance_charges);
    this.combinedFormData.get('additional_discount1')?.setValue(this.Getordertoinvoice_list[0].discount_amount);
    ...
    this.combinedFormData.get('roundoff1')?.setValue(this.Getordertoinvoice_list[0].roundoff);
    this.combinedFormData.get('tax_amount41')?.setValue(this.Getordertoinvoice_list[0].tax_amount);
    this.combinedFormData.get('tax_name41')?.setValue(this.Getordertoinvoice_list[0].tax_name);
   this.producttotalamount1 = this.Getordertoinvoice_list[0].net_amount;
    this.grandtotal11=  this.Getordertoinvoice_list[0].grand_total;
    ...
    this.deliverytoInvoiceSummary(this.salesorder_gid);
  ...
  deliverytoInvoiceSummary(salesorder_gid: any){
    
    debugger
    let param = { salesorder_gid : salesorder_gid}
    this.NgxSpinnerService.show();
    var productsummaryapi = 'SmrTrnSalesorder/GetDeliveryToInvoiceProductSummary';
    ...
    this.deliverytoInvoiceproductSummary(this.salesorder_gid);
    });
    this.NgxSpinnerService.hide();
  }
  onClearCurrency() {
...
debugger
  ...
  finaltotal() {
    debugger
    {
      const total_amount = isNaN((this.combinedFormData.value.tax_amount4)) ? 0 : (this.combinedFormData.value.tax_amount4);
  ...
  deliverytoInvoiceproductSummary(salesorder_gid:any) {
    debugger
    this.NgxSpinnerService.show();
   let param ={ salesorder_gid : salesorder_gid}
    var api = 'SmrTrnSalesOrder/GetDeliveryToInvoiceProductDetails';
