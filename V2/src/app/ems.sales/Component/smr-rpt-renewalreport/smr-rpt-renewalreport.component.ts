...
@Component({
  selector: 'app-smr-rpt-renewalreport',
  templateUrl: './smr-rpt-renewalreport.component.html',
  styleUrls: ['./smr-rpt-renewalreport.component.scss']
})
export class SmrRptRenewalreportComponent {
  chartOptions1: any = {};
  labels_value: any;
  ...
  GetSmrTrnEmployeeCount(){
   ...
   GetInvoiceForLastSixMonths() {
    debugger
    this.NgxSpinnerService.show();
    var url = 'SmrTrnRenewalmanagersummary/GetRenewalReportForLastSixMonths'
    this.service.get(url).subscribe((result: any) => {
   ...
   onSearchClick() {
    debugger
    var url = 'SmrTrnRenewalmanagersummary/GetRenewalReportForLastSixMonthsSearch';
    this.NgxSpinnerService.show()
  ...
  ondetail(month: any, year: any) {
   ...
   console.log("cejcjning")
    var url = 'SmrTrnRenewalmanagersummary/GetrenewalDetailSummary'
    let param = {
