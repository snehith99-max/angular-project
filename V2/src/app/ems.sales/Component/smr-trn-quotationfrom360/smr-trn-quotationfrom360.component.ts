...
@Component({
  selector: 'app-smr-trn-quotationfrom360',
  templateUrl: './smr-trn-quotationfrom360.component.html',
  styleUrls: ['./smr-trn-quotationfrom360.component.scss']
})
export class SmrTrnQuotationfrom360Component {
